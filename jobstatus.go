...
func (s *JobStatus) GetGraphQlBulkJobStatus(ctx context.Context, id string, opts ...operations.Option) (*operations.GetGraphQlBulkJobStatusResponse, error) {
	request := operations.GetGraphQlBulkJobStatusRequest{
		ID: id,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/graphqlbulkjob/{id}", request, nil)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "getGraphQlBulkJobStatus",
		OAuth2Scopes:     nil,
	...
	res := &operations.GetGraphQlBulkJobStatusResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GraphQLBulkJobRetrievalResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GraphQLBulkJobRetrievalResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
