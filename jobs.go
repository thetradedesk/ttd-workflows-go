...
func newJobs(rootSDK *Workflows, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Jobs {
	return &Jobs{
		rootSDK:          rootSDK,
...
func (s *Jobs) GetStatus(ctx context.Context, id string, opts ...operations.Option) (*operations.GetGraphQlQueryJobStatusResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/graphqlqueryjob/{id}", request, nil)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "getGraphQlQueryJobStatus",
		OAuth2Scopes:     []string{},
	...
	res := &operations.GetGraphQlQueryJobStatusResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GraphQLQueryJobRetrievalResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GraphQLQueryJobRetrievalResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
