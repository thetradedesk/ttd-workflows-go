...
func newCampaigns(rootSDK *Workflows, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Campaigns {
	return &Campaigns{
		rootSDK:          rootSDK,
...
func (s *Campaigns) CreateCampaign(ctx context.Context, request *components.CampaignCreateWorkflowInputWithValidation, opts ...operations.Option) (*operations.CreateCampaignResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/campaign")
	if err != nil {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CampaignPayload
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CampaignPayload = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Campaigns) BulkCreate(ctx context.Context, request *components.CampaignBulkCreateWorkflowInputWithValidation, opts ...operations.Option) (*operations.CreateCampaignsJobResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/standardjob/campaign/bulk")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CreateCampaignsJobResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Campaigns) BulkUpdate(ctx context.Context, request *components.CampaignBulkUpdateWorkflowInputWithValidation, opts ...operations.Option) (*operations.UpdateCampaignsJobResponse, error) {
	...
	res := &operations.UpdateCampaignsJobResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Campaigns) Archive(ctx context.Context, forceArchive *bool, requestBody []string, opts ...operations.Option) (*operations.ArchiveCampaignsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/campaign/archive")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ArchiveCampaignsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// GetCampaignVersion - Get a campaign's version
func (s *Campaigns) GetCampaignVersion(ctx context.Context, id string, opts ...operations.Option) (*operations.GetCampaignVersionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/campaign/{id}/version", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CampaignVersionWorkflow
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CampaignVersionWorkflow = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
