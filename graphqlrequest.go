...
func newGraphQLRequest(rootSDK *Workflows, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *GraphQLRequest {
...
// SubmitGraphQlBulkQueryJob - Submit a valid bulk GraphQL query job
...
func (s *GraphQLRequest) SubmitGraphQlBulkQueryJob(ctx context.Context, request *components.GraphQlQueryJobInput, opts ...operations.Option) (*operations.SubmitGraphQlBulkQueryJobResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/graphqlbulkqueryjob")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "submitGraphQlBulkQueryJob",
		OAuth2Scopes:     nil,
	...
	res := &operations.SubmitGraphQlBulkQueryJobResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GraphQlBulkJobResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GraphQlBulkJobResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
