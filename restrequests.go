...
func newRestRequests(rootSDK *Workflows, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RestRequests {
	return &RestRequests{
		rootSDK:          rootSDK,
...
func (s *RestRequests) Submit(ctx context.Context, request *components.CallRestAPIWorkflowInput, opts ...operations.Option) (*operations.SubmitRestRequestResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/restrequest")
	if err != nil {
	...
	res := &operations.SubmitRestRequestResponse{
