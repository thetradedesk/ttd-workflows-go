...
// Generated from OpenAPI doc version v1 and generator version 2.916.2
...
func New(opts ...SDKOption) *Workflows {
	sdk := &Workflows{
		SDKVersion: "0.13.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.3 2.916.2 v1 github.com/thetradedesk/ttd-workflows-go",
