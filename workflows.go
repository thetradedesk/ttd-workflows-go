...
// Generated from OpenAPI doc version v1 and generator version 2.937.18
...
func New(opts ...SDKOption) *Workflows {
	sdk := &Workflows{
		SDKVersion: "0.14.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 0.14.0 2.937.18 v1 github.com/thetradedesk/ttd-workflows-go",
			SDKVersion:        "0.14.0",
			GenVersion:        "2.937.18",
