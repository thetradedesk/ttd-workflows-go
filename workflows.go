...
// Generated from OpenAPI doc version v1 and generator version 2.730.5
...
func New(opts ...SDKOption) *Workflows {
	sdk := &Workflows{
		SDKVersion: "0.12.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.12.0 2.730.5 v1 github.com/thetradedesk/ttd-workflows-go",
